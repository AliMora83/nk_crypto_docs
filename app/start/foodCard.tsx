  ...
  return (
	...
	<div className="flex justify-between pb-4 border-bottom">
		<div className="flex items-center">
			<p className=" doc_p dark:text-gray-200">Food Organisations</p>
		</div>
		<p className=" doc_p">More info here</p>
	</div>
	<div className="space-y-4">
		<div className="space-y-2">
			<img src="/food_org.png" alt="" className="block object-cover object-center w-full rounded-md h-72 dark:bg-gray-500" />
